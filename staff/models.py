...
class StaffMember(Sortable):
    ...
    title = models.CharField(
        ...
        blank=False,
        default='',
        help_text=u'Provide a Job title for this staff member',
        max_length=128,
    )
    ...
    bio = PlaceholderField('staff_bio', related_name='bio')

    contact = PlaceholderField('staff_contact', related_name='contact')
