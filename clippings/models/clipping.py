...
class Clipping(Sortable):
    ...
    source = models.CharField('source',
        blank=True,
        default='',
        help_text=u'Please provide a source for this clipping.',
        max_length=255,
    )
    ...
    download = FilerFileField(
        blank=True,
        null=True,
        help_text=u'Provide a file download. This overrides research items and external links.',
    )
...
#
def link_staff_to_nes_item(sender, instance, action, pk_set, **kwargs):
